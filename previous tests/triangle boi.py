...
if triangle == "right angled":
    ...
    if looking_for == "side":
        while play == False:
            looking_for_2 = input("What side are you looking for? ")
            if looking_for_2 == "A":
    ...
    |_ _ _ _ _/_ _ _\\
           ...
           """+str(B)+"""
                    ...
                    if correct == "y":
                        X_value = math.degrees(math.acos(B/A))
                        print("\nX = "+str(X_value)+"°")
                        play = True
                    elif correct == "n":
                        play = False
...
"""+str(C)+"""  |        \\
    ...
    |_ _ _ _ _/_ _ _\\
           ...
           """+str(B)+"""
                    ...
                    correct = input("Is this correct (y/n)? ")
                    if correct == "y":
                        X_value = math.degrees(math.atan(C/B))
                        print("\nX = "+str(X_value)+"°")
                        play = True
                    elif correct == "n":
                        play = False
...
"""+str(C)+"""  |        \\ """+str(A)+"""
    ...
    |_ _ _ _ _/_ _ _\\
                    ...
                    correct = input("Is this correct (y/n)? ")
                    if correct == "y":
                        X_value = math.degrees(math.asin((C/A)))
                        print("\nX = "+str(X_value)+"°")
                        play = True
                    elif correct == "n":
                        play = False
